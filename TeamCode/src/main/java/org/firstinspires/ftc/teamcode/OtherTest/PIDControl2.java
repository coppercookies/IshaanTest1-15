...
@Autonomous(name="PIDControl2", group = "Examples")
public class PIDControl2 extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        DcMotorControllerEx motorControllerEx = (DcMotorControllerEx) armSlider.getController();

        // get the port number of our configured motor.
        int motorIndex = ((DcMotorEx) armSlider).getPortNumber();
